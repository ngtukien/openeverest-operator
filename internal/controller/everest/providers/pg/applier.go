...
func (p *applier) Replication() error {
	if p.DB.Spec.Replication != nil {
		return errors.New("logical replication is not supported by the Percona PostgreSQL provider")
	}
	return nil
}
...
func (p *applier) ReplicaCluster() error {
	if p.DB.Spec.Replica != nil {
		return errors.New("replica clusters are not supported by the Percona PostgreSQL provider")
	}
	return nil
}
